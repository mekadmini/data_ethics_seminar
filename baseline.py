...
def run_baseline(max_workers=4, target_model="llama3", judge_model="llama-guard3", n_repeat=1,
                 dataset_split="train[:30]", resume_from=None):
    """
...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Run a clean baseline test for all matrix languages without translations.")
    ...
    parser.add_argument('--dataset_split', type=str, default='train[:30]',
                        help='Dataset split to use (e.g. train[:315])')
    parser.add_argument('--resume_from', type=str, default=None,
                        help='Directory to resume the study from (e.g., experiment_results/baseline_2024...)')
